...
<div class="waveBackgroundEnd py-10 min-h-[500px]">
    ...
    <div class="container flex mt-5 gap-10">
        ...
        <div class="flex flex-col h-full w-auto">
            <button class="w-auto border-4 border-[#1e1e1e] bg-[#1e1e1e] text-xl mt-4 py-3 px-10 rounded-full text-white transition duration-300 active:duration-0 flex items-center gap-4">
