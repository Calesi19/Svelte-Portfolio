        ...
        <div class="flex flex-col h-auto w-auto justify-center">
            ...
            <div class="flex flex-col w-full xl:flex-row lg:gap-4">
                ...
                <a href="/documents/Resume-Carlos.pdf" download>
                    <button class="w-full bg-blue-500 hover:bg-blue-600 active:bg-blue-500 text-lg mt-4 py-4 md:py-3 px-10 rounded-full text-white transition duration-300 active:duration-0 flex items-center gap-4">
